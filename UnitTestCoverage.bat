...
%DotNet_Path% build SimpleCalculatorApp.sln
...
%DotNet_Path% test --no-build --collect:"XPlat Code Coverage" --results-directory:.\%Report_Folder_Name% SimpleCalculatorApp.tests
